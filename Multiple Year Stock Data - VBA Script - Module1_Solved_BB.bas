...
Dim WS As Worksheet
    ...
    WS.Activate
        ...
        ' Defining column headers for summary
        Cells(1, "I").Value = "Ticker"
        Cells(1, "J").Value = "Yearly Change"
        Cells(1, "K").Value = "Percent Change"
        Cells(1, "L").Value = "Total Stock Volume"
        
        'Defining Variables to hold Value
        ...
        Open_Price = Cells(2, Column + 2).Value
         ...
         ' Looping through all ticker types
        For i = 2 To lastRow
         ' Checking to see if we are still within the same ticker symbol, if it is not...
            If Cells(i + 1, Column).Value <> Cells(i, Column).Value Then
                ...
                ' Adding Yearly Change
                Yearly_Change = Close_Price - Open_Price
                Cells(Row, Column + 9).Value = Yearly_Change
                Cells(Row, Column + 9).NumberFormat = "0.00000000"
        ...
        ' Determining the Last Row of Yearly Change per WS
        YCLastRow = WS.Cells(Rows.Count, Column + 8).End(xlUp).Row
        ' Setting Cell Colors for Yearly Change Column
        ...
        ' Setting Greatest % Increase, % Decrease, and Total Volume headers
        ...
        ' Evaluating each row to find the greatest value and its associate ticker
